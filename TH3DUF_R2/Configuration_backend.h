...
#define HOMING_FEEDRATE_XY (50*60)
  ...
  #if ENABLED(EZABL_EXPERT_PLUGIN)
    #define Z_SAFE_HOMING_X_POINT LEFT_PROBE_BED_POSITION
    #define Z_SAFE_HOMING_Y_POINT FRONT_PROBE_BED_POSITION
  #else
...
#if DISABLED(OCTOPRINT_OPTIMIZED)
  #define SDSUPPORT
#endif
