...
#include "Configuration_th3d.h"
    ...
    #if ENABLED(TMC_CREALITY_BOARD) || ENABLED(CR10S_PRO)
...
#if ENABLED(CR10SDUALEBOARD) || ENABLED(TIM_AM8) || (ENABLED(MKS_PRINTER) && ENABLED(DUAL_EXTRUDER_SINGLE_HOTEND)) || ENABLED(DUAL_HOTEND_DUAL_NOZZLES) || ENABLED(GEEETECH_A20M) || ENABLED(GEEETECH_A10M)
  #define EXTRUDERS 2
#else
  #define EXTRUDERS 1
#endif
